...
def Split_datatset(dataset_txt_path,train_txt_path,test_txt_path,testratio):
    '''
    划分数据集:训练和测试
    data_path：数据集的保存路径
    '''
    ...
    train_x,test_x,train_y,test_y = train_test_split(img_paths,labels,stratify=labels,test_size=testratio,random_state=42)
